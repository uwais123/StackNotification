package com.masuwes.stacknotification
...
class MainActivity : AppCompatActivity() {
    ...
    // declare model from NotificationItem
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        btnSend.setOnClickListener {
            ...
            if (sender.isEmpty() || message.isEmpty()) {
                ...
                // close keyboard when button clicked
    ...
    private fun sendNotif() {
        ...
        val largeIcon = BitmapFactory.decodeResource(resources, R.drawable.ic_notif)
